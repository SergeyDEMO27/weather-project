...
const Main: React.FC = () => {
  ...
  const selectedTitle = JSON.parse(localStorage.getItem('selectedTitle')!) || 'Москва';
  ...
  return (
    <div className='main'>
      <div className='main__container'>
        ...
        {selectedCityTitle && <h2 className='main__title'>{selectedCityTitle}</h2>}
        {!errorWeather && <WeatherContainer selectedCityTitle={selectedCityTitle} />}
      </div>
    </div>
  );
};
